    ...
    def save(self,**kwargs):
        ...
        with transaction.atomic():
            for sheet_name in sheets_name:
                ...
                categories_verbose = [str(category).lower().strip('\t') for category in sheet[categories_name]]
                ...
                questions = [str(question).lower().strip('\t') for question in sheet[questions_name]]
                ...
                for type_name in types_name:
                    ...
                    for i in range(len(type_sheet)):
                        content = str(type_sheet[i]).lower().strip('\t').strip('\n')
                        id_category = None
                        if questions[i] == 'nan':
